...
CATALOG = {
    ...
    # Korean settlement, production and defence features (주거·생산·방어 유구)
    "Pit Dwelling (Round)": "원형 수혈주거지",
    "Pit Dwelling (Square)": "방형 수혈주거지",
    "Pit Dwelling (Protruding Entrance)": "철(凸)자형 수혈주거지",
    "Pit Dwelling (Twin-room)": "여(呂)자형 수혈주거지",
    "Raised-floor Building": "굴립주건물",
    "Cooking Stove (Kamado)": "부뚜막",
    "Ondol Heating Flue": "온돌",
    "Pottery Kiln": "토기가마",
    "Roof Tile Kiln": "기와가마",
    "Iron Smelting Feature": "제철유구",
    "Charcoal Kiln": "숯가마",
    "Paddy Field": "논",
    "Dry Field": "밭",
    "Earthen Rampart Fortress": "토성",
    "Stone Rampart Fortress": "석성",
    "Mountain Fortress": "산성",
    "Palisade": "목책",
    "Encircling Ditch": "환호",
    "Beacon Station": "봉수",
    ...
    "Chopper": "찍개",
    "Tanged Point": "슴베찌르개",
    "Microblade Core": "좀돌날몸돌",
    "Polished Stone Dagger": "간돌검",
    "Semi-lunar Stone Knife": "반달돌칼",
    "Stone Hoe": "돌괭이",
    "Grinding Slab and Muller": "갈판과 갈돌",
    "Stone Arrowhead": "돌화살촉",
    "Net Sinker": "어망추",
    "Coarse-lined Bronze Mirror": "다뉴조문경",
    "Fine-lined Bronze Mirror": "다뉴세문경",
    "Bronze Rattle": "청동방울",
    "Bronze Bell": "동탁",
    "Iron Sword": "철검",
    "Iron Spearhead": "철모",
    ...
    "Comma-shaped Jade (Gogok)": "곡옥",
    "Tubular Jade Bead (Gwanok)": "관옥",
    "Glass Bead": "유리구슬",
    "Gold Earring": "금귀걸이",
    "Gold Crown": "금관",
    "Belt Fitting Set": "대금구",
    "Wooden Document Slip (Mokgan)": "목간",
    "Round Roof-end Tile": "수막새",
    "Eaves Roof Tile": "암막새",
    "Floor Brick": "전돌",
    "Inkstone": "벼루",
    "Clay Figurine": "토우",
